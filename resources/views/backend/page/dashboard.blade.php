...
@extends('backend.layout.page-layout')
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Page Title Here')
@section('content')
    <section class="content-main">
        @include('backend.page.partial.content-header')
        <div class="row">
            <div class="col-lg-3">
                                ...
                                <div class="new-member-list">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="/backend/assets/imgs/people/avatar4.jpg" alt="">
                                            <div>
                                                <h6>Patric Adams</h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="/backend/assets/imgs/people/avatar2.jpg" alt="">
                                            <div>
                                                <h6>Dilan Specter</h6>
                                                <p class="text-muted font-xs">Sanfrancisco</p>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center"><img class="avatar"
                                                src="/backend/assets/imgs/people/avatar3.jpg" alt="">
                                            <div>
                                                <h6>Tomas Baker</h6>
                                                <p class="text-muted font-xs">Sanfrancisco</p>
                                            </div>
